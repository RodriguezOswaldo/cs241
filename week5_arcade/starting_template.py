...
class MyApplication(arcade.Window):
    ...
    def on_draw(self):
        ...
        # Draw the rectangle
        if self.space_press:
            arcade.draw_rectangle_filled(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 50, 60, arcade.color.CORN)
    ...
    def on_key_press(self, key, key_modifiers):
        ...
        # Change the starting example so that when the space bar is pressed,
        # a filled-in square appears in the center of the screen, and when the space bar is released, it goes away.
    ...
    def on_mouse_press(self, x, y, button, key_modifiers):
        ...
        """
        # Change the starting example so that every time the mouse is clicked
        # the speed of the ball increases.
        self.ball_x_pixels_per_second += self.ball_x_pixels_per_second
